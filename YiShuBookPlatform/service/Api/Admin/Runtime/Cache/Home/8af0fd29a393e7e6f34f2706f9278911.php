    ...
    <form class="layui-form bform"  onsubmit="return false" enctype="multipart/form-data" id="form1">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="activityname" value="<?php echo ($list["activityname"]); ?>" placeholder="必填内容" required lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="date" name="activitydate" value="<?php echo ($list["activitydate"]); ?>" placeholder="必填内容" required lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="activityaddress" value="<?php echo ($list["activityaddress"]); ?>" placeholder="必填内容" required lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="activitycontent" value="<?php echo ($list["activitycontent"]); ?>" placeholder="必填内容" required lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="activitylink" value="<?php echo ($list["activitylink"]); ?>" placeholder="必填内容" required lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <div class="file-box">
                    ...
                    <input class="file-txt" type="text" autocomplete="off" name="textfield" id="textfield"><?php if($list[activityposter] != ''): ?><img src="/YiShuBookPlatform/service/Api/Uploads<?php echo ($list["activityposter"]); ?>" height="50"><?php else: endif; ?>
    ...
    <script>
        ...
        function edit() {
            ...
            layui.use('layer', function () {
                ...
                $.ajax({
                    url: "<?php echo U('Activity/doedit');?>",
                    type: 'POST',
                    data: data,
                    dataType: 'json',
                    async: false,
