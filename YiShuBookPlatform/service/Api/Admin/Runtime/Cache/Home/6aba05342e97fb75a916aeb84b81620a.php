...
<div class="aright">
    ...
    <form class="layui-form bform" method="post" action="<?php echo U('links/doadd');?>" enctype="multipart/form-data">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="link" required lay-verify="required" placeholder="必填内容" autocomplete="off" class="layui-input">
            </div>
        </div>
