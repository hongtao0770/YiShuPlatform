    ...
    <form method="post" class="aform cl">
        <table width="100%">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td align="center">
                        <?php if($vo[bookposter] != ''): ?><img src="/YiShuBookPlatform/service/Api/Uploads<?php echo ($vo["bookposter"]); ?>" onclick="img(<?php echo ($vo["bookid"]); ?>);" height="30">
                            <?php else: ?>
                            暂无图片<?php endif; ?>
                    </td>
                    ...
                    <td align="center">
                        <a href="<?php echo U('oldbook/edit',array('bookid'=>$vo['bookid']));?>">修改</a> |
