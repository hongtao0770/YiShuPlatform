...
<div class="aright">
    ...
    <form class="layui-form bform" enctype="multipart/form-data" onsubmit="return false" id="form1">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="author" value="<?php echo ($list["author"]); ?>" placeholder="请输入图书作者" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="bookType" value="<?php echo ($list["booktype"]); ?>" placeholder="请输入图书种类" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="bookPress" value="<?php echo ($list["bookpress"]); ?>" placeholder="请输入出版社" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="radio" name="bookSale" value="1" title="打折" <?php if($list['booksale'] == 1): ?>checked=""<?php endif; ?>>
                <input type="radio" name="bookSale" value="0" title="不打折" <?php if($list['booksale'] == 0): ?>checked=""<?php endif; ?>>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="radio" name="bookShow" value="1" title="首页推荐" <?php if($list['bookshow'] == 1): ?>checked=""<?php endif; ?>>
                <input type="radio" name="bookShow" value="0" title="不推荐" <?php if($list['bookshow'] == 0): ?>checked=""<?php endif; ?>>
            </div>
        </div>
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea name="bookContent" placeholder="请输入内容" class="layui-textarea"><?php echo ($list["bookcontent"]); ?></textarea>
            </div>
        </div>
