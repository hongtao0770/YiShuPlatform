        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <div class="file-box">
                    ...
                    <input class="file-txt" type="text" autocomplete="off" name="textfield" id="textfield"><?php if($l[pic] != ''): ?><img src="/thinkphp_3.2.3_full/Uploads<?php echo ($l["pic"]); ?>" height="50"><?php else: endif; ?>
