...
<div class="aright">
    ...
    <form class="layui-form bform" onsubmit="return false" id="form1">
        <input type="hidden" name="orderId" value="<?php echo ($list["orderid"]); ?>">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="orderPrice" value="<?php echo ($list["orderprice"]); ?>" placeholder="必填内容" required lay-verify="required" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="sessionDate" value="<?php echo ($list["sessiondate"]); ?>" placeholder="请输入内容" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="userId" value="<?php echo ($list["userid"]); ?>" placeholder="请输入内容" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="orderAdress" value="<?php echo ($list["orderadress"]); ?>" placeholder="请输入内容" autocomplete="off" class="layui-input">
            </div>
        </div>
