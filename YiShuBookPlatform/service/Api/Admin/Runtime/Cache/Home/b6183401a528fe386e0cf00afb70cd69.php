...
<div class="aright">
    ...
    <div class="arz cl"><a href="<?php echo U('activity/add');?>"><i class="layui-icon">&#xe608;</i>添加活动</a></div>
    ...
    <form method="post" class="aform cl">
        <table width="100%">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    <td align="center"><?php echo ($vo["activityid"]); ?></td>
                    <td align="center"><?php echo ($vo["activityname"]); ?></td>
                    <td align="center"><?php echo ($vo["activitydate"]); ?></td>
                    <td align="center"><?php echo ($vo["activityaddress"]); ?></td>
                    <td align="center"><?php echo ($vo["activitycontent"]); ?></td>
                    <td align="center"><?php echo ($vo["activitylink"]); ?></td>
                    <td align="center">
                        <?php if($vo[activityposter] != ''): ?><img src="/YiShuBookPlatform/service/Api/Uploads<?php echo ($vo["activityposter"]); ?>" height="30">
                            <?php else: ?>
                            暂无海报<?php endif; ?>
                    </td>
                    <td align="center">
                        <a href="<?php echo U('activity/edit',array('activityid'=>$vo['activityid']));?>">修改</a> |
                        <a href="#" onclick="del(<?php echo ($vo["activityid"]); ?>)">删除</a>
                    </td>
