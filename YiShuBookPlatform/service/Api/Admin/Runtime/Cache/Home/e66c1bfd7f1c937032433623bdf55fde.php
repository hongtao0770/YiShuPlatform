        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <div class="file-box">
                    ...
                    <input class="file-txt" type="text" autocomplete="off" name="textfield" id="textfield"><?php if($b[apic] != ''): ?><img src="/thinkphp_3.2.3_full/Uploads<?php echo ($b["apic"]); ?>" height="50"><?php else: endif; ?>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <div class="file-box">
                    <i class="layui-icon">&#xe61f;</i>
                    <input class="file-btn" type="button" value="选择图片">
                    <input class="file-txt" type="text" autocomplete="off" name="textfieldb" id="textfieldb"><?php if($b[bpic] != ''): ?><img src="/thinkphp_3.2.3_full/Uploads<?php echo ($b["bpic"]); ?>" height="50"><?php else: endif; ?>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <div class="file-box">
                    <i class="layui-icon">&#xe61f;</i>
                    <input class="file-btn" type="button" value="选择图片">
                    <input class="file-txt" type="text" autocomplete="off" name="textfieldc" id="textfieldc"><?php if($b[cpic] != ''): ?><img src="/thinkphp_3.2.3_full/Uploads<?php echo ($b["cpic"]); ?>" height="50"><?php else: endif; ?>
